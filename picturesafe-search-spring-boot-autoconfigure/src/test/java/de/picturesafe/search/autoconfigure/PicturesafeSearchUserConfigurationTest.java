...
public class PicturesafeSearchUserConfigurationTest extends AbstractPicturesafeSearchConfigurationTest {
    ...
    public void defaultRestClientConfigurationBacksOff() {
        this.clientConfigurationContextRunner.withUserConfiguration(UserConfiguration.class).run((context) -> {
            ...
            assertThat(context.getBean(RestClientConfiguration.class).getHostAddresses()).isEqualTo("localhost:9600");
        });
    }
    ...
    static class UserConfiguration {
        ...
        public RestClientConfiguration restClientConfiguration() {
            final RestClientConfiguration rcc = new RestClientConfiguration("localhost:9600");
            rcc.setSnifferEnabled(true);
            return rcc;
        }
    }
}
